...
const TeacherItem: React.FC<TeacherItemProps> = ({
  ...
  return (
    <div
      key={teacher.id}
      className="w-full mb-2 sm:w-1/2 sm:p-1 md:w-1/3 md:p-1 lg:w-1/6 lg:p-1 xl:w-1/6 xl:p-2"
    >
      <input
        type="radio"
        id={`t-${index + 1}`}
                ...
                <div className="text-center bg-gray-50 w-full border rounded-lg mt-2">
                  <table className="w-full divide-gray-200">
                    <thead>
                      {[
                        ["性別", teacher.gender],
                        ["得意なこと", teacher.Strengths],
                        ["趣味", teacher.tastes],
                        ["勤務歴", teacher.workhistory],
                      ].map(([label, value], i) => (
                        <tr key={i}>
                          <td className="border border-slate-200 text-xs">
                            {label}
                          </td>
                          <td className="border border-slate-200 text-xs">
                            {value}
        ...
        <div className=" p-2">
          ...
          <div className="flex flex-row flex-wrap w-full">
            {[1, 2, 3].map((index) => (
              <div
                key={index}
                className="flex flex-col w-full md:w-auto border border-gray-200 rounded-lg p-2 m-1"
              >
                <div className="">
                  ...
                  <div className="mb-3">
                    ...
                    <label className="ms-2 me-2 text-xs text-gray-900">
                      月
                    </label>
                    <select className="p-1 text-xs px-4 bg-gray-100 border-transparent rounded-lg">
                      <option value=""></option>
                        ...
                        <div className="bg-white w-full">
                          ...
                          >
                            ...
                            {Array.from({ length: 18 }, (_, hour) => {
                              ...
                              const formattedTime =
                                timeValue.toLocaleTimeString("ja-JP", {
                                  hour12: false,
                                  hour: "2-digit",
                                  minute: "2-digit",
                                });
                ...
                <div className="bg-blue-500 p-4 flex flex-col rounded-lg">
                  ...
                  <div className="bg-gray-100 p-6 rounded-lg flex flex-col">
                    <p>
                      予約リクエストを送信しました。
                      <br />
                      予約の確定はホーム画面からご確認お願いします。
                      <br />
                      <a className="underline decoration-wavy decoration-red-400">
