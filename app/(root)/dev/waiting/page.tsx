        ...
        <div className="flex flex-col items-center">
            <div className="w-1/2">
                <div className="flex flex-row justify-center">
                    <button
                        className={`w-1/2 p-3 rounded-l-lg shadow-lg border ${isNominationSelected ? 'border-sky-700 bg-sky-700 text-white' : 'border-gray-200 bg-gray-50'}`}
                        ...
                        <div className="mt-2">
                            <Link href="" key={user.id}>
                                <div
                                    ...
                                    className=""
                                >
                                    <button type="button" className="mt-3 mb-3 w-full border-2 bg-white border-gray-100 shadow-md rounded-lg hover:border-2 hover:border-sky-700">
                                        <div className="text-left text-base p-2 mb-2 rounded-t-lg border border-sky-700 bg-sky-700 text-white">
                                            {user.name}<br />
                                        </div>
                                        <div className="bg-gray-50 p-3 px-5 mx-10 my-2">
