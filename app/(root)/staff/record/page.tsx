        ...
        <div className="w-full flex justify-center items-center" key={user.id}>
          <div className="bg-gray-100 w-2/3 rounded-md shadow-md">
            <div className="flex-col text-center mt-5 mb-5">
              <div className="text-gray-900">{user.kana}</div>
              <div className="text-gray-900 text-3xl">{user.name}</div>
                            ...
                            >
                              <div>
                                ...
                                <div className="flex justify-end flex-row">
                                  <button
                                    type="button"
                                    className="mx-2 rounded-lg border border-primary-500 bg-green-300 px-6 py-1 text-center text-sm font-medium text-black shadow-sm transition-all hover:border-primary-700 hover:bg-green-500 hover:text-white"
                                  >
                                    保存
                                  </button>
                                  <button
                                    type="button"
                                    className="rounded-lg border border-primary-500 bg-red-300 px-6 py-1 text-center text-sm font-medium text-black shadow-sm transition-all hover:border-primary-700 hover:bg-red-500 hover:text-white"
                                  >
                                    削除
                                  </button>
                                </div>
