...
const selectedUser: React.FC<selectedUser> = ({ testUsers, testUsers2 }) => {
  ...
  const selectedData =
    selectedOption === "firstChoice" ? testUsers : testUsers2;
    ...
    <div className="flex flex-col items-center h-kd-90-h mt-10 md:mt-2">
      <div className="w-full">
        <div className="flex flex-row justify-center">
          <button
            className={`w-1/2 p-3 pb-5 rounded-l-lg shadow-lg border ${
          ...
          <button
            className={`w-1/2 p-3 pb-5 rounded-r-lg shadow-lg border ${
              !isNominationSelected
                ? "border-kd-sub2-cl bg-kd-sub2-cl text-white"
                : "border-gray-200 bg-gray-50"
            }`}
